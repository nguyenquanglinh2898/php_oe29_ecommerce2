<div class ="notification">
    ...
    <div class="alert alert-{{ $notification->data['class'] }}">
        ...
        <span aria-hidden="true"><i class="material-icons">{{ config('config.clear') }}</i></span>
        </button>
...
<script src="{{ asset('bower_components/bootstrap-material-design/index.css') }}" integrity="sha384-CauSuKpEqAFajSpkdjv3z9t8E7RlpJ1UP0lKM/+NdtSarroVKu069AlsRPKkFBz9" crossorigin="anonymous"></script>
