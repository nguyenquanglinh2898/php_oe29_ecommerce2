...
@section('title', trans('supplier.edit_voucher'))
@section('embed-css')
@endsection
@section('custom-css')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date"
                                    ...
                                    type="date" id="start"
                                    name="start_date"
                                    value="{{ date(config('config.format_year'),strtotime($voucher->start_date)) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date"
                                    ...
                                    type="date" id="start"
                                    name="end_date"
                                    value="{{ date(config('config.format_year'),strtotime($voucher->end_date)) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                class="form-control"
                                id="title"
                                placeholder="{{ trans('supplier.description') }}"
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        class="form-control"
                                        id="title"
                                        placeholder="{{ trans('supplier.quantity') }}"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        class="form-control"
                                        id="title"
                                        placeholder="{{ trans('supplier.min_value') }}"
                                        value="{{ $voucher->min_value }}"
                                        autocomplete="off"
                                        required="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select-apply-for" name="">
                                        <option value="{{ config('config.voucher_freeship') }}" @if ($voucher->discount == config("config.default"))
                                            selected=""
                                        @endif>{{ trans('supplier.freeship') }}</option>
                                        <option value="{{ config('config.voucher_discount') }}" @if ($voucher->freeship == null)
                                            selected=""
                                        @endif>{{ trans('supplier.discount') }}</option>
                                        <option value="{{ config('config.voucher_freeship_discount') }}" @if ($voucher->discount != config("config.default") && $voucher->freeship != null)
                                            selected=""
                            ...
                            <div class="col-md-7 discount" >
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        id="title"
                                        placeholder="{{ trans('supplier.discount') }}"
                        ...
                        <div class="col-md-7 freeship" >
                            <div class="form-group">
                                ...
                                <input type="text"
                                name="freeship"
                                class="form-control freeship-input"
                                id="title"
                                placeholder="{{ trans('supplier.freeship') }}"
                                value="{{ config('config.voucher_freeship') }}"
                                autocomplete="off">
                            </div>
                        </div>
                    </div>
