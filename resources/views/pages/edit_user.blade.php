...
<section class="bread-crumb">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ trans('customer.change_infomation') }}</li>
        </ol>
    </nav>
</section>
<div class="site-user">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-4 col-xs-4">
                                    <div class="upload-avatar">
                                        <div title="Avatar Preview" class="avatar-preview" data-image="{{ Auth::user()->avatar }}"></div>
                                        <label for="upload" title="Upload Avatar"><i class="fas fa-folder-open"></i>{{ trans('customer.upload_avatar') }}</label>
